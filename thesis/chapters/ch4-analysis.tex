...
\subsection{Time complexity of the consensus protocol}
...
we must make some assumptions on the time complexity of consensus protocol.
...
Hence, from~\Cref{sec:acs-complexity}, it directly follows that the consensus protocol has a time complexity of $O(N)$.

\subsection{Communication Cost for Transactions}
\label{sec:communication-cost-for-tx}
With the analysis on the time complexity of consensus protocol,
