...
Bitcoin is also fault-tolerant because attackers can not out pace honest users in finding new blocks unless they have a majority of the computational power,
...
Recent research has developed a class of hybrid systems which uses proof-of-work (PoW) for committee election,
...
To the best of our knowledge, only two systems---Elastico~\cite{luu2016elastico} and OmniLedger~\cite{kokoris2017omniledger}---have experimentally demonstrated horizontal scalability.
...
On the other hand, our system has no restrictions on the Sybil defence mechanism
