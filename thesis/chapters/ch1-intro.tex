...
Due to this limitation, it is not uncommon to see a long backlog of about 20000 transactions\footnote{\url{https://blockchain.info/unconfirmed-transactions/}}.
...
A recent empirical study Croman et el.~\cite{croman2016scaling} has shown that increasing the block size may help.
