...
We begin the detailed discussion by formulating the model \Cref{ch:model}. 
Next, we analyse the correctness, security and performance of our design in \Cref{ch:analysis},
