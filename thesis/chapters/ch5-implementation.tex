...
We evaluate our system experimentally to ultimately understand its scalability characteristics as well as its limitations.
Concretely,
...
\begin{figure}[tb]
  ...
  It has a similar, near linear, trend as~\Cref{fig:round-duration}.
