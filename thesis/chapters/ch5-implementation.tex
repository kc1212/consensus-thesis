...
\Cref{fig:round-comms} show the relationship between communication cost of the consensus protocol per round and population size.
...
Hence, for the same experiment we also record the duration in seconds and the result is shown in~\Cref{fig:round-duration}.
