...
\begin{frame}{\subsecname}
  \begin{itemize}
    ...
    \item Goal 2: create CP blocks at the end of the protocol
...
\begin{frame}{\subsecname:~properties}
\begin{itemize}
  \item Result: we reach consensus on transactions via CP blocks
...
\begin{frame}{Validated transaction throughput (random neighbour)}
  \begin{figure}[h]
